...
def create_basic_cards():
    ...
    cards.extend([
        ...
        Card(
            ...
            power=1,
            toughness=1,
            oracle_text="When Farhaven Elf enters the battlefield, you may search your library for a basic land card, put it onto the battlefield tapped, then shuffle.",
            triggered_abilities=[create_etb_ramp_trigger()],
        ),
        Card(
            id="ondu_giant",
            ...
            power=2,
            toughness=4,
            oracle_text="When Ondu Giant enters the battlefield, you may search your library for a basic land card, put it onto the battlefield tapped, then shuffle.",
            triggered_abilities=[create_etb_ramp_trigger()],
        ),
        Card(
            id="eternal_witness",
